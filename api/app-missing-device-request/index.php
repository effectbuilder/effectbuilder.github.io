 ...
 *
 * **Multipart (schema v3)** — `file_logs_zip` (`rgbjunkie-logs.zip`) with all diagnostic logs.
 * **Multipart (schema v2)** — individual files: `file_rgbjunkie_log`, `file_hardware_snapshot`,
 *   `file_rgb_hardware_debug`, `file_freeze_events`, `file_rgbjunkie_log_prev`
 *
...
$html .= <<<HTML
  <p style="margin-top:24px;font-size:12px;color:#666;">When schema_version is 2 or higher, diagnostic logs are attached (single zip on v3).</p>
</body>
</html>
HTML;
