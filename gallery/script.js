    ...
    function renderProjects(projectDocs) {
        ...
        projectDocs.forEach((doc) => {
            ...
            if (isOwner || isAdmin) {
                ...
                const regenHTML = isAdmin ? `<li><a class="dropdown-item" href="/effect-builder/?effectId=${project.docId}&action=regenThumbnail" target="_blank"><i class="bi bi-arrow-clockwise me-2"></i>Regen Thumb</a></li>` : '';
            ...
            card.innerHTML = `
                <div class="position-relative">
                    <a href="/effect-builder/?effectId=${project.docId}" class="d-block">
                        ${project.thumbnail ?
                ...
                <div class="card-footer d-flex gap-2">
                    <a href="/effect-builder/?effectId=${project.docId}" class="btn btn-primary w-100"><i class="bi bi-box-arrow-down me-2"></i>Load</a>
